...
description: "Útmutató az NVIDIA CUDA és cuDNN beállításához, hogy a Vernacula-Desktop használhassa a GPU-t."
topic_id: first_steps_cuda_installation
---

# A CUDA és cuDNN telepítése GPU-gyorsításhoz

A Vernacula-Desktop képes NVIDIA GPU-t használni az átírás jelentős felgyorsításához. A GPU-gyorsításhoz az NVIDIA CUDA Toolkit és a cuDNN futtatókörnyezeti könyvtárak telepítése szükséges a rendszeren.
...
Töltse le és futtassa a CUDA Toolkit telepítőjét az NVIDIA fejlesztői webhelyéről. A telepítés során fogadja el az alapértelmezett útvonalakat. A telepítő automatikusan beállítja a `CUDA_PATH` környezeti változót — a Vernacula-Desktop ezt a változót használja a CUDA könyvtárak megkereséséhez.
...
A telepítés után zárja be, majd nyissa meg újra a Vernacula-Desktop alkalmazást. Az alkalmazás indításkor ellenőrzi a CUDA jelenlétét.
...
Ha a CUDA nem érhető el, a Vernacula-Desktop automatikusan visszavált CPU-alapú feldolgozásra. Az átírás ekkor is működik, de lassabb lesz, különösen hosszú hangfájlok esetén.
