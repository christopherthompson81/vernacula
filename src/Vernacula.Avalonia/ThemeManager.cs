...
{
    private const string MochaUri = "avares://Vernacula.Avalonia/Themes/MochaTheme.axaml";
    private const string LatteUri = "avares://Vernacula.Avalonia/Themes/LatteTheme.axaml";
